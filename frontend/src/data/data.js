const blogData = [
    {
      ...
      description: "Escape to Bali, where lush landscapes meet serene beaches and vibrant culture.",
      content: `Bali is a destination that captivates every traveler, whether you're looking for relaxation or adventure.  \n
    ...
    },
    {
      ...
      description: "Experience the timeless charm of Paris, from iconic landmarks to quaint streets.",
      content: `Paris, the City of Love, is a dream destination filled with romance, history, and world-class art.  \n
    ...
    },
    {
      ...
      description: "Embark on an adventure through Patagonia's breathtaking glaciers and mountains.",
      content: `Patagonia, the remote and untamed region of South America, is a paradise for adventure seekers and nature lovers.  \n
    ...
    },
    {
      ...
      description: "Get up close with wildlife and explore the savannahs of Kenya.",
    ...
    },
    {
      ...
      description: "Discover the harmony of nature and culture in Japan, from cherry blossoms to Mt. Fuji.",
    ...
    },
    {
      ...
      description: "Immerse yourself in the majestic beauty of the Swiss Alps, a haven for hikers.",
      content: `The Swiss Alps are a dreamland for adventure enthusiasts and nature lovers alike.  \n
      Begin your journey in Zermatt, home to the Matterhorn, one of the most iconic peaks in the world. Take the Gornergrat Railway to witness breathtaking panoramic views of the surrounding mountains and glaciers.  \n
      For those who love trekking, the Jungfrau Region is a must-visit. Trails like the Eiger Trail and Schynige Platte to First offer some of the most picturesque hikes in Europe. If you're looking for an easy, scenic route, consider the Five Lakes Walk, which gives stunning reflections of the Matterhorn in crystal-clear alpine lakes. \n 
    ...
    },
    {
      ...
      description: "Relax on pristine beaches and dive into crystal-clear waters in the Maldives.",
      content: `The Maldives is a slice of paradise, where pristine beaches, luxurious overwater bungalows, and vibrant marine life create the ultimate getaway.\n
      Wake up to the sound of waves in an overwater villa, where the turquoise ocean stretches endlessly before you. Start your morning with snorkeling or scuba diving at the Banana Reef, one of the Maldives’ most famous diving spots, known for its vibrant coral formations and exotic sea creatures. \n
      For those looking to unwind, take a sunset cruise on a traditional dhoni boat, where you might even spot playful dolphins swimming alongside. Visit Vaadhoo Island at night to witness the magical bioluminescent plankton, which makes the ocean glow like a starry sky. \n

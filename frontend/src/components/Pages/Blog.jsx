                ...
                {blogs.map((blog, index) => (
                  ...
                  >
                    <img
                      ...
                      alt={blog.title}
                      className={`w-full ${
                        index === 0||1 ? "h-96 object-cover" : "h-56 object-cover"
                      }`}
                    />
                    <div className="p-6 bg-white">
                      <p className="text-sm text-gray-500 font-agdasima font-semibold tracking-wide">
                        {blog.author} • {blog.date}
                      </p>
                      <h3 className="text-lg font-semibold text-gray-800 mt-2 font-libreCaslon">
                        {blog.title}
                      </h3>
                    </div>
                  </Link>
